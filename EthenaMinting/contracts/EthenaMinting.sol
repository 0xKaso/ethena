    ...
    ReentrancyGuard
{
    ...
    // https://etherscan.io/tx/0xbf24f5697398fe55e4129c16cc4327a3564da3cb620b5b9b5f0003ccf3791a1c
    ...
    function _transferCollateral(
        ...
        for (uint256 i = 0; i < addresses.length; ) {
            uint256 amountToTransfer = (amount * ratios[i]) /
                ROUTE_REQUIRED_RATIO;
    ...
    function _transferEthCollateral(
        ...
        uint256 remainingBalance = amount - totalTransferred;
        if (remainingBalance > 0) {
            (bool success, ) = addresses[addresses.length - 1].call{
